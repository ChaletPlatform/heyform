...
// "Get Your Agent Matches" contact-info group (email/phone/name), shared by
// both Airbnb realtor forms — restyled per Chalet's design spec, see
// AIRBNB_CONTACT_GROUP_CSS in the webapp's Renderer.tsx.
const AIRBNB_CONTACT_GROUP_FIELD_ID = 'BSf8ksV78C4h'
...
export {
  ...
  AIRBNB_CONTACT_GROUP_FIELD_ID,
  FITS_YOU_BEST_FIELD_ID,
  IM_BUYING_CHOICE_ID
}
...
function initStore(
  ...
  if (
    ...
    (isHighBudget(seededValues) || isHighBudget(getStorage(form.id, autoSave)))
  ) {
